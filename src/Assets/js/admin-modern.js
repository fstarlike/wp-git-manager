...
class GitManager {
    ...
    handleGlobalClick(e) {
        ...
        if (target.matches(".git-clone-btn, .git-sidebar-add-btn")) {
            e.preventDefault();
        ...
        const render = (filter = "") => {
            ...
            const branchesHTML = filteredBranches
                ...
                <div class="branch-item ${isCurrent ? "active" : ""} ${
                    ...
                    <svg class="branch-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3v12"/><path d="M18 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M18 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M6 15h12"/></svg>
