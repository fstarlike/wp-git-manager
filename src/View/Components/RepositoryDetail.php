...
class RepositoryDetail
{
    public function render()
    {
        ...
        <div class="git-repo-details" id="git-repo-details" style="display: none;">
            ...
            <div class="repo-details-header">
                <h2 id="repo-details-name"><?php echo esc_html__('Repository', 'git-manager'); ?></h2>
                <div class="repo-details-actions">
                    <button class="git-action-btn" data-action="pull" title="<?php echo esc_attr__('Pull changes', 'git-manager'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M12 17V3"/>
                            <path d="m6 11 6 6 6-6"/>
                            <path d="M19 21H5"/>
                        </svg>
                        <?php echo esc_html__('Pull', 'git-manager'); ?>
                    </button>
                    <button class="git-action-btn" data-action="push" title="<?php echo esc_attr__('Push changes', 'git-manager'); ?>">
                        ...
                        <?php echo esc_html__('Push', 'git-manager'); ?>
                    </button>
                    <button class="git-action-btn git-secondary-btn" data-action="fetch" title="<?php echo esc_attr__('Fetch updates', 'git-manager'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <?php echo esc_html__('Fetch', 'git-manager'); ?>
                    </button>
                    <button class="git-action-btn git-secondary-btn" data-action="status" title="<?php echo esc_attr__('Check status', 'git-manager'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
                            <circle cx="12" cy="12" r="10"/>
                            <path d="M12 16v-4"/>
                            <path d="M12 8h.01"/>
                        </svg>
                        <?php echo esc_html__('Status', 'git-manager'); ?>
                    </button>
                    <button class="git-action-btn git-secondary-btn" data-action="troubleshoot" title="<?php echo esc_attr__('Professional troubleshooting', 'git-manager'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
                            <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>
                        </svg>
                        <?php echo esc_html__('Troubleshoot', 'git-manager'); ?>
                    </button>
                    <button class="git-action-btn git-secondary-btn" data-action="fix-permission" title="<?php echo esc_attr__('Fix permissions', 'git-manager'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
                            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                        </svg>
                        <?php echo esc_html__('Fix Permissions', 'git-manager'); ?>
                    </button>
                </div>
            </div>
    ...
    private function renderRepositoryInfoGrid()
    {
        ...
        <div class="repo-info-grid">
            <div class="repo-info-item">
                <label><?php echo esc_html__('Repository Name', 'git-manager'); ?></label>
                <span id="repo-name" class="value">-</span>
                <div class="skeleton skeleton-text skeleton-placeholder"></div>
            </div>
            <div class="repo-info-item">
                <label><?php echo esc_html__('Local Path', 'git-manager'); ?></label>
                <span id="repo-path" class="value">-</span>
                <div class="skeleton skeleton-text skeleton-placeholder"></div>
            </div>
            <div class="repo-info-item">
                <label><?php echo esc_html__('Current Branch', 'git-manager'); ?></label>
                <span id="repo-branch" class="value">-</span>
                <div class="skeleton skeleton-text skeleton-placeholder"></div>
            </div>
            <div class="repo-info-item">
                <label><?php echo esc_html__('Status', 'git-manager'); ?></label>
                <span id="repo-status" class="value">-</span>
                <div class="skeleton skeleton-text skeleton-placeholder"></div>
            </div>
            <div class="repo-info-item">
                <label><?php echo esc_html__('Last Commit', 'git-manager'); ?></label>
                <span id="repo-last-commit" class="value">-</span>
                <div class="skeleton skeleton-text skeleton-placeholder"></div>
            </div>
            <div class="repo-info-item">
                <label><?php echo esc_html__('Remote URL', 'git-manager'); ?></label>
    ...
    private function renderRepositoryTabs()
    {
        ...
        <div class="git-repo-tabs">
            <button class="git-repo-tab active" data-tab="overview"><?php echo esc_html__('Overview', 'git-manager'); ?></button>
            <button class="git-repo-tab" data-tab="commits"><?php echo esc_html__('Recent Commits', 'git-manager'); ?></button>
            <button class="git-repo-tab" data-tab="branches"><?php echo esc_html__('Branches', 'git-manager'); ?></button>
            <button class="git-repo-tab" data-tab="troubleshooting"><?php echo esc_html__('Troubleshooting', 'git-manager'); ?></button>
            <button class="git-repo-tab" data-tab="settings"><?php echo esc_html__('Settings', 'git-manager'); ?></button>
        </div>
        <?php
    }
            ...
            <div class="repo-status-card overview-card" data-card="status">
                <div class="overview-card-header repo-status-header">
                    <div class="overview-card-title-wrap">
                        ...
                        <h3 class="overview-card-title"><?php echo esc_html__('Repository Status', 'git-manager'); ?></h3>
                    </div>
                ...
                <div class="repo-status-content overview-card-body" id="repo-status-content">
                        <div class="status-label-wrap">
                            <span class="status-label value" id="repo-status-label"><?php echo esc_html__('Loading...', 'git-manager'); ?></span>
                        </div>
                        <div class="status-body" id="repo-status-body">
                    <p class="value"><?php echo esc_html__('Loading repository status...', 'git-manager'); ?></p>
                    <div class="skeleton skeleton-text skeleton-placeholder"></div>
            ...
            <div class="repo-branch-card overview-card" data-card="branch">
                <div class="overview-card-header repo-branch-header">
                    <div class="overview-card-title-wrap">
                        ...
                        <h3 class="overview-card-title"><?php echo esc_html__('Branch Information', 'git-manager'); ?></h3>
                    </div>
                </div>
                <div class="repo-branch-content overview-card-body" id="repo-branch-content">
                    <div class="branch-topline">
                        <span class="branch-name value" id="branch-name"><?php echo esc_html__('Loading...', 'git-manager'); ?></span>
                    ...
                    <div class="branch-sync-status" id="branch-sync-status">
                        <p class="value"><?php echo esc_html__('Loading branch information...', 'git-manager'); ?></p>
            ...
            <div class="repo-changes-card overview-card" data-card="changes">
                <div class="overview-card-header repo-changes-header">
                    <div class="overview-card-title-wrap">
                        ...
                        <h3 class="overview-card-title"><?php echo esc_html__('Recent Changes', 'git-manager'); ?></h3>
                    </div>
                ...
                <div class="repo-changes-content overview-card-body" id="repo-changes-content">
                    <div class="changes-list" id="changes-list">
                        <p class="value"><?php echo esc_html__('Loading changes...', 'git-manager'); ?></p>
            ...
            <div class="repo-commit-card overview-card" data-card="commit">
                <div class="overview-card-header repo-commit-header">
                    <div class="overview-card-title-wrap">
                        ...
                        <h3 class="overview-card-title"><?php echo esc_html__('Last Commit', 'git-manager'); ?></h3>
                    </div>
                    <div class="commit-time" id="commit-time">
                        <span class="value"><?php echo esc_html__('Loading...', 'git-manager'); ?></span>
                ...
                <div class="repo-commit-content overview-card-body" id="repo-commit-content">
                    <div class="last-commit-info" id="last-commit-info">
                        <p class="value"><?php echo esc_html__('Loading commit information...', 'git-manager'); ?></p>
                        <div class="skeleton skeleton-text skeleton-placeholder"></div>
                        <div class="skeleton skeleton-text skeleton-placeholder" style="width:80%;"></div>
                    </div>
                </div>
        ...
        <div class="repo-recommendations overview-card" id="repo-recommendations" style="display: none;" data-card="recommendations">
            <div class="overview-card-header">
                <div class="overview-card-title-wrap">
                    ...
                    <h3 class="overview-card-title"><?php echo esc_html__('Recommendations', 'git-manager'); ?></h3>
                </div>
            </div>
        ...
        <div class="commits-section">
            <div class="commits-list">
                <div class="loading-commits">
                    ...
                    <span><?php echo esc_html__('Loading commits...', 'git-manager'); ?></span>
                </div>
            </div>
        </div>
        <?php
    ...
    private function renderBranchesTab()
    {
        ...
        <div class="branches-section">
            <div class="branches-header">
                <h3><?php echo esc_html__('Branches', 'git-manager'); ?></h3>
                <div class="branch-search-container">
                    <input type="text" id="branch-search-input" placeholder="<?php echo esc_attr__('Search branches...', 'git-manager'); ?>">
                </div>
            </div>
            <div class="branches-list">
                <div class="loading-branches">
                    <div class="progress-spinner"></div>
                    <span><?php echo esc_html__('Loading branches...', 'git-manager'); ?></span>
                </div>
            </div>
        </div>
        <?php
            ...
            <div class="settings-form repository-settings-form">
                <div class="form-section">
                    <h4 class="form-section-title">
                        ...
                        <?php echo esc_html__('Basic Information', 'git-manager'); ?>
                    </h4>

                    <div class="form-group">
                        <label for="repo-name-setting"><?php echo esc_html__('Repository Name', 'git-manager'); ?></label>
                        <input type="text" id="repo-name-setting" class="form-control" placeholder="<?php echo esc_attr__('Repository name', 'git-manager'); ?>" required>
                        <div class="form-help"><?php echo esc_html__('The display name for this repository', 'git-manager'); ?></div>
                    </div>

                    <div class="form-group">
                        <label for="repo-path-setting"><?php echo esc_html__('Repository Path', 'git-manager'); ?></label>
                        <input type="text" id="repo-path-setting" class="form-control" placeholder="<?php echo esc_attr__('Repository path', 'git-manager'); ?>" required>
                        <div class="form-help"><?php echo esc_html__('The local path to this repository', 'git-manager'); ?></div>
                    </div>

                    <div class="form-group">
                        <label for="repo-remote-setting"><?php echo esc_html__('Remote URL', 'git-manager'); ?></label>
                        <input type="text" id="repo-remote-setting" class="form-control" placeholder="<?php echo esc_attr__('https://github.com/user/repo.git', 'git-manager'); ?>">
                        <div class="form-help"><?php echo esc_html__('The remote repository URL (optional)', 'git-manager'); ?></div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    <h4 class="form-section-title">
                        ...
                        <?php echo esc_html__('Actions', 'git-manager'); ?>
                    </h4>
                    ...
                    <div class="form-actions">
                        <button type="button" id="save-settings-btn" class="git-action-btn git-primary-btn">
                            ...
                            <?php echo esc_html__('Save Settings', 'git-manager'); ?>
                        </button>
                    </div>
                </div>
            </div>
