    ...
    public function render()
    {
        ...
        <div class="git-repo-sidebar">
            <div class="git-repo-sidebar-header">
                <h3><?php echo esc_html__('Repositories', 'git-manager'); ?></h3>
                <button class="git-sidebar-add-btn git-clone-btn" title="<?php echo esc_attr__('Add Repository', 'git-manager'); ?>">
            ...
            <div class="git-repo-list" id="git-repo-list">
                ...
                <div class="git-repo-empty">
                    <p><?php echo esc_html__('Loading repositories...', 'git-manager'); ?></p>
                </div>
            </div>
        </div>
        <?php
